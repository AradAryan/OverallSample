...
function initVm(arg) {
    ...
    var vm = kendo.observable({
        ...
        onShowUser: function(e) {
            e.preventDefault();
            var dataItem = this.dataItem($(e.currentTarget).closest('tr'));
            selectedItemId = dataItem.CorporateId;
            location.href = 'http://localhost/UI/Corporate/GetCorporateUsers/' + selectedItemId;
            return false;
        },
        ...
        onNewUser: function (e) {
            ...
            var dataItem = this.dataItem($(e.currentTarget).closest('tr'));
            selectedItemId = dataItem.CorporateId;
            location.href = 'http://localhost/UI/Corporate/NewUser?corporateId=' + selectedItemId;
            return false;
        ...
        SearchDS: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    dataType: "json",
                    type: 'POST',
                    url: arg.customerDetailUrl + '/Corporate/Search',
                    data: {
